...
public class OrderController {
   ...
   *
   * <p>Only users with role USER can create orders.
   *
   * @param dto the order data transfer object containing user email, items, and shipping
   *     information
   ...
   *
   * <p>- Users can only access their own orders. - Admins can access any order.
   *
   ...
   *
   * <p>Only users with role USER may access this endpoint, and they may only view their own orders.
   *
   ...
   *
   * <p>Only users with role ADMIN can call this endpoint.
   *
   ...
   *
   * <p>Only admins can modify order statuses (e.g., PROCESSING, SHIPPED, COMPLETED).
   *
   ...
   *
   * <p>Rules: - Only users (ROLE_USER) - User must own the order - Order must still be cancelable
   * (not shipped, etc.)
   *
   * @param id the order ID
   ...
   *
   * <p>Only admins are allowed to delete orders.
   *
   ...
   *
   * <p>Rules: - Only ROLE_USER - User must own the order - Order must be eligible for return (e.g.,
   * delivered already)
   *
   * @param id the order ID
