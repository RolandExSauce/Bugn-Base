...
-- message table -> user can send messages to admins
...
INSERT INTO products (name, category, description, price, shipping_cost, brand, stock_status, shipping_time, active) VALUES
    ('PrestoTune White-F', 'PIANOS', 'Elegant white finish piano with advanced soundboard technology for superior acoustics.', 350000, 0, 'PrestoTune Pianos', TRUE, 5, TRUE),
    ('Newerton Pro', 'PIANOS', 'Professional studio piano with weighted keys and authentic grand piano sound.', 99900, 0, 'Newerton', TRUE, 5, FALSE),
    ('StrumVista Blue', 'PIANOS', 'Unique blue finish upright piano with exceptional dynamic range and tone control.', 220000, 0, 'StrumVista Black', TRUE, 5, TRUE),
    ('PrestoTune Grand LX', 'PIANOS', 'Luxury grand piano with handcrafted soundboard and premium ebony keys.', 5000000, 10000, 'PrestoTune Pianos', TRUE, 5, TRUE),
    ('StrumVista Black', 'PIANOS', 'Premium black grand piano with enhanced resonance and sustain.', 999900, 12000, 'StrumVista Guitars', TRUE, 5, TRUE),
    ('EchoLynx White x2', 'PIANOS', 'Compact white piano with dual speaker system for immersive sound experience.', 39900, 2500, 'EchoLynx Crafters', TRUE, 5, TRUE),
    ( 'EchoLynx Crafters', 'PIANOS', 'Artisan-crafted piano with custom tonewoods for warm, balanced sound.', 49900, 0, 'EchoLynx Crafters', TRUE, 5, FALSE),
    ('SonataCraft LX red', 'PIANOS', 'Striking red grand piano with concert hall voicing and precision action.', 5559900, 0, 'SonataCraft Pianos', TRUE, 5, TRUE),
    ('Black Upright p44', 'PIANOS', 'Classic upright piano with rich bass response and smooth key action.', 300000, 0, 'Melodique Keys', TRUE, 5, TRUE),
    ( 'Melodique Baby Grand', 'PIANOS', 'Compact grand piano delivering full-sized performance in smaller spaces.', 139900, 0, 'Melodique Keys', TRUE, 5, TRUE),
    ('Melodique Piano', 'PIANOS', 'Professional upright piano with German hammer action and solid spruce soundboard.', 550000, 0, 'Melodique Keys', TRUE, 5, TRUE),
    ( 'PrestoTune Klamm-33', 'PIANOS', 'Entry-level digital piano with authentic weighted key feel and multiple voices.', 40000, 0, 'PrestoTune Pianos', TRUE, 5, TRUE),
    ('EchoRidge Keyboard Midi', 'PIANOS', 'Versatile MIDI controller piano with premium keybed and extensive connectivity.', 49900, 5500, 'EchoRidge Keyboards', TRUE, 5, TRUE),
    ('SonataCraft g66', 'PIANOS', 'Handcrafted concert grand with patented sound projection system.', 1200000, 0, 'SonataCraft Pianos', TRUE, 5, TRUE),
    ('FretHarmony', 'PIANOS', 'Studio-quality upright with silent practice system and Bluetooth connectivity.', 99900, 0, 'FretHarmony Instruments', TRUE, 5, TRUE),
    ('StrumVibe', 'PIANOS', 'Modern digital piano with realistic hammer action and onboard lesson functions.', 87500, 1200, 'SoundForge', TRUE, 3, TRUE),
    ('EchoTone', 'PIANOS', 'Vintage-inspired upright piano with warm tonal character and classic styling.', 149900, 2500, 'ClassicKeys Co.', FALSE, 6, FALSE),
    ('HarmonyFire', 'PIANOS', 'Hybrid piano combining acoustic soundboard with digital versatility.', 79900, 1000, 'Virtuoso Makers', TRUE, 2, TRUE),
    ('BassBloom', 'PIANOS', 'Compact digital piano with exceptional bass response and portable design.', 65900, 900, 'ToneRiver', TRUE, 7, TRUE),
    ( 'ChordBliss', 'PIANOS', 'Professional stage piano with premium samples and advanced effects.', 132000, 3000, 'ClassicKeys Co.', FALSE, 4, TRUE);

-- anfängliche bilder, add more if needed
INSERT INTO images (image_id, url, product_id) VALUES
-- 🎹 PIANOS
('00000000-0000-0000-0000-000000000001', '/product_images/pianos/p-1.jpg', 1),
('00000000-0000-0000-0000-000000000002', '/product_images/pianos/p-6.jpg', 1),
('00000000-0000-0000-0000-000000000003', '/product_images/pianos/p-7.jpg', 2),
('00000000-0000-0000-0000-000000000004', '/product_images/pianos/p-12.jpg', 2),
('00000000-0000-0000-0000-000000000005', '/product_images/pianos/p-15.jpg', 3),
('00000000-0000-0000-0000-000000000006', '/product_images/pianos/p-20.jpg', 3),

-- 🎸 GUITARS (mapped to VALID product IDs)
('00000000-0000-0000-0000-000000000007', '/product_images/guitars/g-1.jpg', 4),
('00000000-0000-0000-0000-000000000008', '/product_images/guitars/g-8.jpg', 4),
('00000000-0000-0000-0000-000000000009', '/product_images/guitars/g-5.jpg', 5),
('00000000-0000-0000-0000-000000000010', '/product_images/guitars/g-11.jpg', 5),

-- 🎻 VIOLINS (mapped to VALID product IDs)
('00000000-0000-0000-0000-000000000011', '/product_images/violins/v-2.jpg', 6),
('00000000-0000-0000-0000-000000000012', '/product_images/violins/v-7.jpg', 6);
...
('ORD-9001', '99999999-9999-9999-9999-999999999999',
 3250.00, '2025-05-12', '2025-05-17', 'shipped',
 '852 Pine St, Cityville', 'creditcard'),

-- Peo Oneal
('ORD-10001', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa',
 1599.00, '2025-05-28', NULL, 'processing',
 '963 Willow Way, Capitol City', 'paypal');


INSERT INTO reviews (review_id, product_id, user_id, rating, comment, created_at) VALUES
  ('r-001', 1, '11111111-1111-1111-1111-111111111111', 5, 'Fantastic piano! Great sound quality.', NOW() - INTERVAL '12 days'),
  ('r-002', 3, '22222222-2222-2222-2222-222222222222', 4, 'Solid performance and beautiful design.', NOW() - INTERVAL '30 days'),
  ('r-003', 5, '33333333-3333-3333-3333-333333333333', 3, 'Good but a bit overpriced.', NOW() - INTERVAL '18 days'),
  ('r-004', 2, '44444444-4444-4444-4444-444444444444', 5, 'Amazing value for the price.', NOW() - INTERVAL '5 days'),
  ('r-005', 7, '55555555-5555-5555-5555-555555555555', 2, 'Not what I expected.', NOW() - INTERVAL '42 days'),
  ('r-006', 10, '66666666-6666-6666-6666-666666666666', 4, 'Great instrument, fast shipping.', NOW() - INTERVAL '8 days'),
  ('r-007', 14, '77777777-7777-7777-7777-777777777777', 5, 'The best piano I ever bought.', NOW() - INTERVAL '2 days'),
  ('r-008', 12, '88888888-8888-8888-8888-888888888888', 3, 'Decent quality.', NOW() - INTERVAL '21 days'),
  ('r-009', 18, '99999999-9999-9999-9999-999999999999', 4, 'Quite impressive for the price.', NOW() - INTERVAL '14 days'),
  ('r-010', 4, 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 1, 'Very disappointed with the build quality.', NOW() - INTERVAL '70 days');
