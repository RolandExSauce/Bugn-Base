...
('StrumVibe', 'GUITARS', 'Modern digital piano with realistic hammer action and onboard lesson functions.', 87500, 1200, 'SoundForge', 'IN_STOCK', 3, TRUE),
('EchoTone', 'GUITARS', 'Vintage-inspired upright piano with warm tonal character and classic styling.', 149900, 2500, 'ClassicKeys Co.', 'OUT_OF_STOCK', 6, FALSE),
